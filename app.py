...
app.config['JWT_SECRET_KEY'] = 'jwt-clave-secreta-super-segura-cambiar-en-produccion'
...
def get_dishes():
    ...
    try:
        ...
        dishes = list(dishes_collection.find(query).sort('totalOrders', -1))
...
if __name__ == '__main__':
    ...
    print("⚠️  Para uso en dispositivos móviles, cambia 'localhost' por tu IP local")
